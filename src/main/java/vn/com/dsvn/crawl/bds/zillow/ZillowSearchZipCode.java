...
public class ZillowSearchZipCode {
	private static Logger logger = LoggerFactory.getLogger(ZillowSearchZipCode.class);
	...
	public static void main(String[] args) {
		ZillowSearchZipCode zillowSearch = new ZillowSearchZipCode();
		try {
			zillowSearch.run();
		} catch (IOException e) {
			e.printStackTrace();
